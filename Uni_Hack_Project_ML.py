...
def KNN_Implementation(training_data, input_data):
    ...
    for key in frequency_dict:
        if frequency_dict[key] == max_freq:
            ...
            return(f'The most suitable plant is {key}.')
...
if __name__ == '__main__':
    ...
    salinity = float(input('Enter salinity of water: '))
    pH = float(input('Enter pH of water: '))
    temperature = float(input('Enter temperature of environment: '))
    concentration = float(input('Enter concentration of Ca²⁺ in water: '))
